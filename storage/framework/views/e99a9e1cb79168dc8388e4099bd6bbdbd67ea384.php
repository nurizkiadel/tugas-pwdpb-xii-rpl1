...
<html lang="en">
   <head>
      ...
      .btn-login:hover{
          background: #ffc9de !important;
          border: 1px solid #ffc9de !important;
      }
      .mfa-white {
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading">kiyowoo pict</h3>
                    <br>
                    <h4 class="myp-slider text-center"><b>cutties</b></h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp">
                <h3 class="title-heading text-center font-weight-bold">mypict</h3>
...
<script>
  ...
  </html><?php /**PATH C:\belajar_laravel\resources\views/galeri.blade.php ENDPATH**/ ?>