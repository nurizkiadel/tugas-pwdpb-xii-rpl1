...
<html lang="en">
 ...
 body {
      ...
      header.masthead .overlay{position:absolute;background-color:#cca9dd;height:100%;width:100%;top:0;left:0;opacity:.3}
      ...
      .mfa-white {
          color: rgb(233, 224, 206) !important;
      }
      
      h3.my-heading {
          font-family: 'Kaushan Script', cursive;
          color: rgb(233, 224, 206);
          font-weight: bold;
          font-size: 30px;
          margin:0;
      }
      ...
      */
      ...
      .card:hover {
          color: #222 !important;
          box-shadow: 0 1px 3px 0 #c1bbdd, 0 0 0 1px #c1bbdd;
      }
    ...
    body {
      ...
      .heading {
        ...
        padding:1%;
        text-align:left;
        box-shadow:0px 0px 4px 0px #c1bbdd;
      }
        ...
        <div class="container slider-top-text">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h3 class="my-heading"> <span class="bg-main">PROFILkuu</span></h3>
                    <br>
                    <h4 class="myp-slider text-center "><b>yg kepo scroll yuk</b></h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 wow fadeInUp">
                <h3 class="title-heading text-center font-weight-bold">anyeong disini profilku</h3>
            </div>
        </div>
        <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="bio-content">
                      ...
                      <br>
                      <h5>haii..</h5><h5>kenalin namaku NURIZKI ADELIA AZZAHRO biasanya dipanggil adel.</h5>
                      <h5> alamat rumahku dayurejo-Prigen, daerah wisata di pegunungan hehe.</h5><h5>sekarang adel sudah kls 12 di SMKN 1 PURWOSARI dan mengambil jurusan rpl.</h5><h5></h5>
                      <h5></h5>
                    </div>
                  </div>
                </div>	
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 text-center text-lg-left my-auto  wow zoomIn">
                    ...
                    <p style="color:rgb(242, 184, 216);">* Nurizki Adelia Azzahro</p>
                    <p style="color:rgb(242, 184, 216);">* XII RPL 1</p>
                    <p style="color:rgb(242, 184, 216);">* Rekayasa Perangkat Lunak</p>
                </div>
...
<script>
  ...
  </html><?php /**PATH C:\belajar_laravel\resources\views/profil.blade.php ENDPATH**/ ?>